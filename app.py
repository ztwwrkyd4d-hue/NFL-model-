...
<div class="brand-container">
    <div class="brand-title">PICKZW<span>DON</span> <span style="font-size:14px; color:#34d399;">NFL</span></div>
...
st.markdown(f'<div class="pill-label">Select NFL Week</div>', unsafe_allow_html=True)
w_cols = st.columns(4)
...
matchups = NFL_SCHEDULE[current_week]
...
<div class="matchup-container">
    <div class="team-box"><div class="team-badge-pill">{away_team}</div><div class="team-title">{NFL_TEAMS.get(away_team, away_team)}</div><div style="font-size:9px; color:#9ca3af; font-weight: 700; margin-top:2px;">AWAY</div></div>
    <div class="vs-box">VS</div>
    <div class="team-box"><div class="team-badge-pill">{home_team}</div><div class="team-title">{NFL_TEAMS.get(home_team, home_team)}</div><div style="font-size:9px; color:#9ca3af; font-weight: 700; margin-top:2px;">HOME</div></div>
</div>
""", unsafe_allow_html=True)
